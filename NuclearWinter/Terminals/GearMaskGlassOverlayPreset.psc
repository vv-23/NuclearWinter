ScriptName NuclearWinter:Terminals:GearMaskGlassOverlayPreset extends Terminal
...
Event OnMenuItemRun(int auiMenuItemID, ObjectReference akTerminalRef)
	...
	ElseIf (auiMenuItemID == Stage1)
		MaskOverlay.VisualFX = GasMask_GearOverlayVisual_Stage1
	ElseIf (auiMenuItemID == Stage2)
		MaskOverlay.VisualFX = GasMask_GearOverlayVisual_Stage2
	ElseIf (auiMenuItemID == Stage3)
		MaskOverlay.VisualFX = GasMask_GearOverlayVisual_Stage3
	ElseIf (auiMenuItemID == Stage4)
		MaskOverlay.VisualFX = GasMask_GearOverlayVisual_Stage4
	ElseIf (auiMenuItemID == Stage5)
		MaskOverlay.VisualFX = GasMask_GearOverlayVisual_Stage5
	ElseIf (auiMenuItemID == Stage6)
		MaskOverlay.VisualFX = GasMask_GearOverlayVisual_Stage6
